...
const SingleProductPage = () => {
    ...
    const {singleProduct, singleFilteredProduct, isSingle} = useContext(authContext)
    const {id} = useParams()
        ...
        <div className='row'>
            <h1>cart page</h1>
            {
                isSingle ? (
                    ...
                    <div className='mt-5'>
                        {
                            singleFilteredProduct.lenght > 0 ? (
                                                    ...
                                                    <div className="card h-100 shadow-sm">
                                                        ...
                                                        <small className="text-muted">
                                                         ...
                                                         <div className="mt-3 text-center mb-4">
                                                            <button className="btn btn-primary" onClick={() => addToCart(singleFilteredProduct)}>
                                                            Add to Cart
                                                            </button>
                                                        </div>
                                                    </div>
